...
heart_data.output.value_counts() # df.target.unique()
disease = len(heart_data[heart_data['output'] == 1])
no_disease = len(heart_data[heart_data['output']== 0])
...
top15 = corr.nlargest(top, 'output')['output'].index
